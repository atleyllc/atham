...
/**
 * Opus helpers for the public-firmware voice stream (command 0x07, 48 kHz).
 * Current source firmware uses 16 kHz IMA ADPCM on command 0x0C instead.
 */
public final class OpusUtils {
    ...
    public static class OpusDecoderWrapper {
        ...
        public OpusDecoderWrapper(int sampleRate, int frameSize) {
            ...
            this.pcmShorts = new short[frameSize];
        }
    ...
    public static class OpusEncoderWrapper {
        ...
        public OpusEncoderWrapper(int sampleRate, int frameSize) {
            this.encoder = new OpusEncoder(sampleRate, 1, OpusApplication.OPUS_APPLICATION_VOIP);
            this.frameSize = frameSize;
